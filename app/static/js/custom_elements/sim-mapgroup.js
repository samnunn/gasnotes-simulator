        ...
        connectedCallback() {
            ...
            this.map.addEventListener("input", (e) => {
                ...
                if (dbp_val <= this.dbp.min && sbp_val >= this.sbp.max) {
                    ...
                    dbp_val <= this.dbp.min &&
                    sbp_val - dbp_val < this.pulseWidth
                ) {
            ...
            // HACK #smell
            // listens for input ONCE during pageload hydration
            this.dbp.addEventListener(
                "input",
                () => {
                    this.updatePulseWidth();
                },
